...
setTimeout(() => {
  document.getElementById("valText").style.opacity = "1";
  document.getElementById("valText").style.transform = "translateY(0)";

  document.getElementById("aiName").style.opacity = "1";
  document.getElementById("aiName").style.transform = "translateY(0)";
}, delay_2 + 400);
